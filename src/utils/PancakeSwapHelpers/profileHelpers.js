...
import { getPancakeProfileContract, getPancakeSquadContract, getPancakeBunnyContract } from "./contractHelpers";
...
export const getUserData = async (account) => {
  ...
  return { userId, numberPoints, teamId, nftAddress, tokenId, isActive };
};
