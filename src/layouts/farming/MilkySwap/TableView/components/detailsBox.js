...
import { MilkySwapTextLogo } from "assets/images/Logos/Dapps";
  ...
  return (
    <SuiBox>
      <Stack spacing={0}>
        ...
        <Link href={`https://www.milkyswap.exchange/add/${tokenAddress}/${quoteTokenAddress}`} target="_blank" underline="none" sx={{ fontSize: 14 }}>
