...
import { getLpContract } from "utils/MilkyDexHelpers/contractHelpers";
...
function ApproveButton({ lpAddress }) {
  ...
  async function approveContract() {
    await FarmContract.methods
      .approve(contract.milkyChef.contractAddressl, "115792089237316195423570985008687907853269984665640564039456726971375468411753")
      .send({ from: account })
