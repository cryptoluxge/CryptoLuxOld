...
import { getLpContract, getMasterChefV2 } from "utils/PancakeSwapHelpers/contractHelpers";
import Web3 from "web3";
import { useWeb3React } from "@web3-react/core";

function DepositButton({ pid, lpAddress, name, token, quoteToken, buttonName }) {
        ...
        <SuiBox sx={style}>
          ...
          <SuiBox>
            ...
            <Grid container spacing={1}>
              <Grid item>
                <SuiInput id="cakeToDeposit" onChange={(e) => stakeButtonState(e)} placeholder={`${name} რაოდენობა`} />
              </Grid>
              <Grid item>
