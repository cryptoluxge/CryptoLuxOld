...
function ApproveButton() {
  ...
  async function checkApprove() {
    const isApproved = await BSWContract.methods.allowance(account, contract.AutoBSWPool.contractAddress).call();
  ...
  async function approveContract() {
    await BSWContract.methods
      .approve(contract.AutoBSWPool.contractAddress, "115792089237316195423570985008687907853269984665640564039456726971375468411753")
      .send({ from: account })
